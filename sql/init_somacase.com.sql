...
INSERT INTO `service` VALUES
	...
	(200, 'The Cobblestone Collection'	, 3200, '[ {case_type, normal}, {play_line_key, coll_base_line}, {rank_points, 0}, {tag_filter, [#{category => "ItemSet", internal_name => "set_cobblestone"}]} ].', 0, 0, 0),
	(201, 'The Gods And Monsters Collection', 3200, '[ {case_type, normal}, {play_line_key, coll_base_line}, {rank_points, 0}, {tag_filter, [#{category => "ItemSet", internal_name => "set_gods_and_monsters"}]} ].', 0, 0, 0),
	(202, 'The Chop Shop Collection', 3200, '[ {case_type, normal}, {play_line_key, coll_base_line}, {rank_points, 0}, {tag_filter, [#{category => "ItemSet", internal_name => "set_chopshop"}]} ].', 0, 0, 0),
	(203, 'The Overpass Collection', 3200, '[ {case_type, normal}, {play_line_key, coll_base_line}, {rank_points, 0}, {tag_filter, [#{category => "ItemSet", internal_name => "set_overpass"}]} ].', 0, 0, 0),
	(204, 'The Rising Sun Collection', 3200, '[ {case_type, normal}, {play_line_key, coll_base_line}, {rank_points, 0}, {tag_filter, [#{category => "ItemSet", internal_name => "set_kimono"}]} ].', 0, 0, 0),
	(205, 'The Assault Collection', 3200, '[ {case_type, normal}, {play_line_key, coll_base_line}, {rank_points, 0}, {tag_filter, [#{category => "ItemSet", internal_name => "set_assault"}]} ].', 0, 0, 0),
	(206, 'The Baggage Collection', 3200, '[ {case_type, normal}, {play_line_key, coll_base_line}, {rank_points, 0}, {tag_filter, [#{category => "ItemSet", internal_name => "set_baggage"}]} ].', 0, 0, 0),
	(207, 'The Cache Collection', 3200, '[ {case_type, normal}, {play_line_key, coll_base_line}, {rank_points, 0}, {tag_filter, [#{category => "ItemSet", internal_name => "set_cache"}]} ].', 0, 0, 0),
	(208, 'The Safehouse Collection', 3200, '[ {case_type, normal}, {play_line_key, coll_base_line}, {rank_points, 0}, {tag_filter, [#{category => "ItemSet", internal_name => "set_safehouse"}]} ].', 0, 0, 0),
	(209, 'The Militia Collection', 3200, '[ {case_type, normal}, {play_line_key, coll_base_line}, {rank_points, 0}, {tag_filter, [#{category => "ItemSet", internal_name => "set_militia"}]} ].', 0, 0, 0),
	(210, 'The Dust 2 Collection', 3200, '[ {case_type, normal}, {play_line_key, coll_base_line}, {rank_points, 0}, {tag_filter, [#{category => "ItemSet", internal_name => "set_dust_2"}]} ].', 0, 0, 0),
	(211, 'The Bank Collection'	, 3200, '[ {case_type, normal}, {play_line_key, coll_base_line}, {rank_points, 0}, {tag_filter, [#{category => "ItemSet", internal_name => "set_bank"}]} ].', 0, 0, 0),
	(212, 'The Mirage Collection', 3200, '[ {case_type, normal}, {play_line_key, coll_base_line}, {rank_points, 0}, {tag_filter, [#{category => "ItemSet", internal_name => "set_mirage"}]} ].', 0, 0, 0),
	(213, 'The Nuke Collection', 3200, '[ {case_type, normal}, {play_line_key, coll_base_line}, {rank_points, 0}, {tag_filter, [#{category => "ItemSet", internal_name => "set_nuke"}]} ].', 0, 0, 0),
	(214, 'The Dust Collection', 3200, '[ {case_type, normal}, {play_line_key, coll_base_line}, {rank_points, 0}, {tag_filter, [#{category => "ItemSet", internal_name => "set_dust"}]} ].', 0, 0, 0),
	(215, 'The Office Collection', 3200, '[ {case_type, normal}, {play_line_key, coll_base_line}, {rank_points, 0}, {tag_filter, [#{category => "ItemSet", internal_name => "set_office"}]} ].', 0, 0, 0),
	(216, 'The Italy Collection', 3200, '[ {case_type, normal}, {play_line_key, coll_base_line}, {rank_points, 0}, {tag_filter, [#{category => "ItemSet", internal_name => "set_italy"}]} ].', 0, 0, 0),
	(217, 'The Inferno Collection', 3200, '[ {case_type, normal}, {play_line_key, coll_base_line}, {rank_points, 0}, {tag_filter, [#{category => "ItemSet", internal_name => "set_inferno"}]} ].', 0, 0, 0),
	(218, 'The Vertigo Collection', 3200, '[ {case_type, normal}, {play_line_key, coll_base_line}, {rank_points, 0}, {tag_filter, [#{category => "ItemSet", internal_name => "set_vertigo"}]} ].', 0, 0, 0),
	(219, 'The Aztec Collection', 3200, '[ {case_type, normal}, {play_line_key, coll_base_line}, {rank_points, 0}, {tag_filter, [#{category => "ItemSet", internal_name => "set_aztec"}]} ].', 0, 0, 0),
	(220, 'The Train Collection', 3200, '[ {case_type, normal}, {play_line_key, coll_base_line}, {rank_points, 0}, {tag_filter, [#{category => "ItemSet", internal_name => "set_train"}]} ].', 0, 0, 0),
	(221, 'The Lake Collection'	, 3200, '[ {case_type, normal}, {play_line_key, coll_base_line}, {rank_points, 0}, {tag_filter, [#{category => "ItemSet", internal_name => "set_lake"}]} ].', 0, 0, 0),
	(222, 'The Alpha Collection', 3200, '[ {case_type, normal}, {play_line_key, coll_base_line}, {rank_points, 0}, {tag_filter, [#{category => "ItemSet", internal_name => "set_bravo_ii"}]} ].', 0, 0, 0),
...
-- INSERT INTO `promocode` VALUES (NULL, 1, 'RP-lutu', '[].', '2017-03-01 00:00:00', 0, 1000, 0);
-- INSERT INTO `promocode` VALUES (NULL, 1, 'flash-is-here', '[].', '2017-02-18 03:59:00', 0, 300, 0);
-- INSERT INTO `promocode` VALUES (NULL, 1, 'promo', '[].', '2017-02-14 03:59:00', 0, 400, 0);

...
INSERT INTO `service` VALUES
	(3000, 'Steam Market Trade'	, 92000, '[ ].', 0, 0, 0); -- Выставка предмета Steam к продаже на торговой площадке
UNLOCK TABLES;
...
INSERT INTO `service_cost` VALUES
	-- (RUB, 643)
    (3000, 643, 0), -- 'Market Trade cost stub'

	-- (EUR, 978)
    (3000, 978, 0), -- 'Market Trade cost stub'

	-- (USD, 840)
    (3000, 840, 0); -- 'Market Tradeb cost stub'
UNLOCK TABLES;
